  ...
  return <section id="contato" ref={sectionRef} className="section-padding bg-gray-100">
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* WhatsApp */}
          <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="bg-white rounded-lg shadow-sm p-8 text-center transition-all hover:-translate-y-1 hover:shadow-md appear-animation">
          ...
          {/* Instagram */}
          <a href={instagramUrl} target="_blank" rel="noopener noreferrer" className="bg-white rounded-lg shadow-sm p-8 text-center transition-all hover:-translate-y-1 hover:shadow-md appear-animation">
